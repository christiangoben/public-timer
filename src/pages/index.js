    ...
    <>
      ...
      <div className="flex flex-col items-center mt-8 p-3">
        ...
        <p className="text-center mb-3">
          The <strong className="primary">Timer</strong> button allows you to set quick time intervals. (ex. how long
          until we meet in the parking lot for carpool, when the burgers will be off the grill )<br />
        </p>
        <p className="text-center mb-3">
          The <strong className="primary">Countdown</strong> button allows you to count down to a specific date or
          event. (birthdays, due-dates, vacation countdowns, etc.)
        </p>
        <p className="text-center flex items-center">
          <span className="mr-1 text-xl">&#42;</span>
          <span className="px-1">
            To use a <strong className="primary">Countdown</strong>, you'll have to create an account so I can keep track
            of them for you &#129505;
          </span>
        </p>
      </div>
